...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_LOG_ENTRY = 3,                  /* LOG_ENTRY  */
  YYSYMBOL_NEWLINE = 4,                    /* NEWLINE  */
  YYSYMBOL_YYACCEPT = 5,                   /* $accept  */
  YYSYMBOL_logs = 6,                       /* logs  */
  YYSYMBOL_log = 7                         /* log  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "LOG_ENTRY", "NEWLINE",
  "$accept", "logs", "log", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 5: /* log: LOG_ENTRY  */
#line 26 "converter.y"
              { procesar_log(yytext); }
#line 1066 "converter.tab.c"
    break;


#line 1070 "converter.tab.c"
